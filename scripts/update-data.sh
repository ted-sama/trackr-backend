...
echo "=========================================="
echo "🔄 TRACKR - Mise à jour des Données"
echo "=========================================="
...
# 4. GCD (comics) - avec update pour mettre à jour les existants
echo ""
echo "📚 [4/5] Update GCD (comics)..."
node ace import:gcd --auto-download --update --scrape-covers
